...
class CameraObjectHandler:
    ...
    def __init__(self, cfgs):
        ...
        # self.color_info_topic = "/h_d435/rgb/camera_info"
        # self.depth_info_topic = "/h_d435/depth/camera_info"
        # self.intrinsics_topic = "/h_d435/rgb/camera_info"
        
        # self.color_topic = "/h_d435/rgb/h_image_raw"
        # self.depth_topic = "/h_d435/depth/h_image_raw"
    ...
    def pickup(
        ...
        shutdown_service = rospy.ServiceProxy('shutdown_service', Empty)
        time.sleep(5)  # Simulate some work
        shutdown_service()  # Call the service
