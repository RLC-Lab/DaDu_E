...
from anygrasp_manipulation import CameraObjectHandler
...
# TODO
def demo(grasp_object):

# def demo():
    # Checking the proper license folder placement.
    check_license_folder()

    object_handler = CameraObjectHandler(cfgs)
    
    # Eval TODO
    
    object_handler.manipulate(grasp_object)
    manipulate_done_event.set()

    # while True:
    #     # object_handler.manipulate()
    #     object_handler.manipulate(grasp_object)
        # grasp_object=input("Enter the object name: ")
        # object_handler.manipulate(grasp_object)
